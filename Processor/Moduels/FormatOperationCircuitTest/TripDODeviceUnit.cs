...
{
    internal class OperationDODeviceEnd
    {
        public List<Core> cores = new List<Core>();
        public ValueTuple<Device, Board, Port> StartPort;
        public OperationDODeviceEnd(ValueTuple<Device, Board, Port> StartPort)
        {
    ...
    internal class OperationDO
    {
        public OperationDODeviceEnd dODeviceEnd1;
        public OperationDODeviceEnd dODeviceEnd2;
        public OperationDO(OperationDODeviceEnd dODeviceEnd1, OperationDODeviceEnd dODeviceEnd2)
        {
    ...
    internal class TripCloseTest
    {
        public OperationDO trip;
        public OperationDO close;
        public TripCloseTest(OperationDO trip, OperationDO close)
        {
            this.trip = trip;
            this.close = close;
        }
